...
class Crypt
{
	class Encrypt
	{
		...
		{
; *********************
			MsgBox, 0, Crypt Data, Here is the Info passed to Crypt`,`nCrypt file path  - %pFileIn%`nOpen file path - %pFileOut%`nThe PassWord is - %password%
		...
		{
; ******************			
			MsgBox, 0, Decrypt Data, Here is the Info passed to Crypt`,`nCrypt file path  - %pFileIn%`nOpen file path - %pfileOut%`nThe PassWord is - %password%
