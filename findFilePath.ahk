...
findFilePath()
{
	...
	*/
	...
	FilePath := "C:\Users\gjackson\Desktop\Copy of 1 Plus Report.crpt"
...
encryptFile(FilePathOpen)
{
	...
	FilePathCrpt := StrReplace(FilePath, .xlsx) . ".crpt"
...
{
	InputBox, userPassPhrase, Please enter the PassPhrase to De-crypt your file, HIDE
	; FilePathCrpt is encrypted file path to be decrypted
	FilePathOpen := StrReplace(FilePathCrpt, .crpt) . ".xlsx"
